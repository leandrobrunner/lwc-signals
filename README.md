...
```
ln -s ./node_modules/lwc-signals/signals ./force-app/main/default/lwc/signals
```
...
```
mklink /D "force-app\main\default\lwc\signals" "node_modules\lwc-signals\signals"
```

Option B: Using PowerShell

```
New-Item -ItemType SymbolicLink -Path "force-app\main\default\lwc\signals" -Target "node_modules\lwc-signals\signals"
```
